    ...
    async function getCode(email){
        ...
        try {
            ...
            if(res.status === 1){
                ...
                message.error(checkLanguage({vi: 'Email đã tồn tại trong hệ thống hoặc bạn vừa yêu cầu gửi mail, vui lòng chờ 120 giây hoặc sử dụng Email khác', en: 'Code has just sent to your email. Please check!'}, language))
            }
        } catch (error) {
            console.log(error);
        }
                ...
                <form onSubmit={handleReg}>
                    ...
                    <div className="form-group half va-t">
                        ...
                        <div className="input-password">
                            ...
                            size="1x" color="#000" className="eye" icon={faEye}/>
                            <input 
                            onChange={e=>{
                                if(!e.target.value.match(validateForm.password)){
                                    e.target.nextElementSibling.classList.add('show')
