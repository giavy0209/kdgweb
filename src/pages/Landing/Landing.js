                    ...
                    <div className="kdg-container">
                        ...
                        <div className="part4__body">
                            ...
                            <div className="part4__body__step">
                                ...
                                <p>{checkLanguage({vi : "Bạn đã trở thành đối tác của KDG và truy cập" , en : "Congratulation! You became our KDG partner. Going to" } , language)} <a href="https://kingdomgame.org/" target="_blank"><span>kingdomgame.org</span></a> {checkLanguage({vi : "để xem hiển thị Game của bạn trên giao diện người dùng." , en : "to view your Game in our website and enjoy." } , language)}</p>
                            </div>
                        </div>
                    </div>
                </div>
